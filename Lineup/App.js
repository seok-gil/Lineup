  ...
  return (
    <NavigationContainer>
      <AppStack.Navigator
        ...
        />
        <AppStack.Screen
          name="PlayerRegistForm"
          component={PlayerRegistForm}
          options={{
            title: '선수 인증',
          }}
        />
        ...
        <AppStack.Screen
          name="RegistTab"
          component={PlayerRegistTabScreen}
          options={{
            title: '선수 인증 승인',
          }}
        />
